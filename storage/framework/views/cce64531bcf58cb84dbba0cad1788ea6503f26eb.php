          ...
          <ul class="navbar-nav header-right">
            ...
            <li class="nav-item dropdown header-profile">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item ai-icon">
...
<div class="deznav">
  <div class="deznav-scroll">
    <ul class="metismenu" id="menu">
      <?php if(!empty(Route::current()->parameters()['formato_slug'])): ?>
      <li>
        ...
        <ul aria-expanded="false">
          <?php $__currentLoopData = $declaracion->formatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
              <?php if($formato->agrupacion == "patrimonial"): ?>
              <a href="<?php echo e(url('declaracion/'.$declaracion->id."/".$formato->slug)); ?>"><?php echo e($formato->nombre); ?></a>
            </li>
            <?php endif; ?>
      ...
      <li>
        ...
        <ul aria-expanded="false">
          <?php $__currentLoopData = $declaracion->formatos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($formato->agrupacion == "intereses"): ?>
            <li>
              <a href="<?php echo e(url('declaracion/'.$declaracion->id."/".$formato->slug)); ?>"><?php echo e($formato->nombre); ?></a>
            </li>
            <?php endif; ?>
...
***********************************-->
  ...
  <script src="<?php echo e(asset('js/easy-number-separator.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\declarapat\resources\views/layouts/app.blade.php ENDPATH**/ ?>